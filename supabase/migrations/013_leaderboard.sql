...
BEGIN
  ...
  INSERT INTO match_results (room_id, mode, winner_team, team1_score, team2_score, team1_saves, team2_saves)
  VALUES (v_room.id, v_room.mode, p_winner_team, p_team1_score, p_team2_score, p_team1_saves, p_team2_saves)
